...
def preprocess():
    ...
    train_identity = pw.load(f'{dir}train_identity.pickle', 'rb')
    train_transaction = pw.load(f'{dir}train_transaction.pickle', 'rb')
    test_identity = pw.load(f'{dir}test_identity.pickle', 'rb')
    test_transaction = pw.load(f'{dir}test_transaction.pickle', 'rb')
    ...
    pw.dump(X, f'{dir}X.pickle', 'wb')
    pw.dump(X_test, f'{dir}X_test.pickle', 'wb')
    pw.dump(y, f'{dir}y.pickle', 'wb')
